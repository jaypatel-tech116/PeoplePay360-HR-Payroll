...
const PayslipsView = ({ onViewPayslip }) => {
  const [selectedYear, setSelectedYear] = useState("2025");
  const [statusFilter, setStatusFilter] = useState("All Status");

  const filteredPayslips = INITIAL_PAYSLIPS.filter((p) => {
    if (statusFilter === "All Status") return true;
    return p.paymentStatus === statusFilter;
  });

  const handleDownload = (period) => {
    alert(`Generating official PDF payslip for ${period} (EMP001 - Rahul Sharma)... Download started.`);
  };
      ...
      <div className="odoo-stat-row-4">
        <div className="odoo-stat-box">
          ...
          <div className="odoo-stat-box-meta">
            ...
            <span className="odoo-stat-box-value">12</span>
        ...
        <div className="odoo-stat-box">
          ...
          <div className="odoo-stat-box-meta">
            ...
            <span className="odoo-stat-box-value">₹ 8,40,000</span>
            <span className="odoo-stat-box-sub">All Time</span>
          </div>
        </div>
        ...
        <div className="odoo-stat-box">
          ...
          <div className="odoo-stat-box-meta">
            ...
            <span className="odoo-stat-box-value">₹ 1,68,000</span>
            <span className="odoo-stat-box-sub">All Time</span>
          </div>
        </div>
        ...
        <div className="odoo-stat-box">
          ...
          <div className="odoo-stat-box-meta">
            ...
            <span className="odoo-stat-box-value">₹ 6,72,000</span>
            <span className="odoo-stat-box-sub">All Time</span>
          </div>
        </div>
      </div>
                  ...
                  <td>
                    <div style={{ display: "flex", gap: "6px" }}>
                      <button
                        ...
                        onClick={() => onViewPayslip(p.period)}
                      >
                        👁 View
                      </button>
                      <button
